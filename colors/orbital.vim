...
if &t_Co >= 256 || has("gui_running")
    hi Normal ctermbg=NONE ctermfg=75 cterm=NONE guibg=#000000 guifg=#5fafff gui=NONE
    set background=dark
    hi NonText ctermbg=NONE ctermfg=20 cterm=NONE guibg=bg guifg=#0000d7 gui=NONE
    hi Comment ctermbg=NONE ctermfg=59 cterm=NONE guibg=bg guifg=#5f5f5f gui=NONE
    hi Constant ctermbg=NONE ctermfg=254 cterm=NONE guibg=bg guifg=#e4e4e4 gui=NONE
    hi Error ctermbg=20 ctermfg=223 cterm=NONE guibg=#0000d7 guifg=#ffd7af gui=NONE
    hi Identifier ctermbg=NONE ctermfg=246 cterm=NONE guibg=bg guifg=#949494 gui=NONE
    hi Ignore ctermbg=NONE ctermfg=25 cterm=NONE guibg=bg guifg=#005faf gui=NONE
    hi PreProc ctermbg=NONE ctermfg=254 cterm=NONE guibg=bg guifg=#e4e4e4 gui=NONE
    hi Special ctermbg=NONE ctermfg=180 cterm=NONE guibg=bg guifg=#d7af87 gui=NONE
    hi Statement ctermbg=NONE ctermfg=32 cterm=NONE guibg=bg guifg=#0087d7 gui=NONE
    hi String ctermbg=NONE ctermfg=110 cterm=NONE guibg=#262626 guifg=#87afd7 gui=NONE
    hi Number ctermbg=NONE ctermfg=67 cterm=NONE guibg=bg guifg=#5f87af gui=NONE
    hi Todo ctermbg=NONE ctermfg=254 cterm=bold guibg=bg guifg=#e4e4e4 gui=bold
    hi Type ctermbg=NONE ctermfg=223 cterm=NONE guibg=bg guifg=#ffd7af gui=NONE
    hi Underlined ctermbg=235 ctermfg=137 cterm=NONE guibg=#262626 guifg=#af875f gui=NONE
    hi StatusLine ctermbg=NONE ctermfg=110 cterm=NONE guibg=bg guifg=#87afd7 gui=NONE
    hi StatusLineNC ctermbg=NONE ctermfg=235 cterm=NONE guibg=bg guifg=#262626 gui=NONE
    hi VertSplit ctermbg=NONE ctermfg=235 cterm=NONE guibg=bg guifg=#262626 gui=NONE
    hi TabLine ctermbg=NONE ctermfg=25 cterm=NONE guibg=bg guifg=#005faf gui=NONE
    hi TabLineFill ctermbg=235 ctermfg=254 cterm=NONE guibg=#262626 guifg=#e4e4e4 gui=NONE
    hi TabLineSel ctermbg=NONE ctermfg=223 cterm=NONE guibg=bg guifg=#ffd7af gui=NONE
    hi Title ctermbg=NONE ctermfg=223 cterm=NONE guibg=bg guifg=#ffd7af gui=NONE
    hi CursorLine ctermbg=235 ctermfg=NONE cterm=NONE guibg=#262626 guifg=NONE gui=NONE
    hi LineNr ctermbg=NONE ctermfg=25 cterm=NONE guibg=bg guifg=#005faf gui=NONE
    hi CursorLineNr ctermbg=NONE ctermfg=110 cterm=NONE guibg=bg guifg=#87afd7 gui=NONE
    hi qfLineNr ctermbg=NONE ctermfg=25 cterm=NONE guibg=bg guifg=#005faf gui=NONE
    hi helpLeadBlank ctermbg=NONE ctermfg=254 cterm=NONE guibg=bg guifg=#e4e4e4 gui=NONE
    hi helpNormal ctermbg=NONE ctermfg=254 cterm=NONE guibg=bg guifg=#e4e4e4 gui=NONE
    hi Visual ctermbg=110 ctermfg=0 cterm=NONE guibg=#87afd7 guifg=#000000 gui=NONE
    hi VisualNOS ctermbg=NONE ctermfg=254 cterm=NONE guibg=bg guifg=#e4e4e4 gui=NONE
    hi Pmenu ctermbg=235 ctermfg=246 cterm=NONE guibg=#262626 guifg=#949494 gui=NONE
    hi PmenuSbar ctermbg=NONE ctermfg=254 cterm=NONE guibg=bg guifg=#e4e4e4 gui=NONE
    hi PmenuSel ctermbg=235 ctermfg=223 cterm=NONE guibg=#262626 guifg=#ffd7af gui=NONE
    hi PmenuThumb ctermbg=NONE ctermfg=254 cterm=NONE guibg=bg guifg=#e4e4e4 gui=NONE
    hi FoldColumn ctermbg=NONE ctermfg=235 cterm=NONE guibg=bg guifg=#262626 gui=NONE
    hi Folded ctermbg=NONE ctermfg=25 cterm=NONE guibg=bg guifg=#005faf gui=NONE
    hi WildMenu ctermbg=NONE ctermfg=223 cterm=NONE guibg=bg guifg=#ffd7af gui=NONE
    hi SpecialKey ctermbg=NONE ctermfg=67 cterm=NONE guibg=bg guifg=#5f87af gui=NONE
    ...
    hi DiffDelete ctermbg=NONE ctermfg=20 cterm=NONE guibg=bg guifg=#0000d7 gui=NONE
    ...
    hi Directory ctermbg=NONE ctermfg=254 cterm=NONE guibg=bg guifg=#e4e4e4 gui=NONE
    ...
    hi ColorColumn ctermbg=NONE ctermfg=235 cterm=NONE guibg=bg guifg=#262626 gui=NONE
    hi signColumn ctermbg=NONE ctermfg=223 cterm=NONE guibg=bg guifg=#ffd7af gui=NONE
    hi ErrorMsg ctermbg=20 ctermfg=254 cterm=NONE guibg=#0000d7 guifg=#e4e4e4 gui=NONE
    hi ModeMsg ctermbg=NONE ctermfg=223 cterm=NONE guibg=bg guifg=#ffd7af gui=NONE
    hi MoreMsg ctermbg=NONE ctermfg=223 cterm=NONE guibg=bg guifg=#ffd7af gui=NONE
    hi Question ctermbg=NONE ctermfg=223 cterm=NONE guibg=bg guifg=#ffd7af gui=NONE
    hi WarningMsg ctermbg=NONE ctermfg=223 cterm=NONE guibg=bg guifg=#ffd7af gui=NONE
    ...
    hi Function ctermbg=NONE ctermfg=250 cterm=NONE guibg=bg guifg=#bcbcbc gui=NONE
    hi Operator ctermbg=NONE ctermfg=137 cterm=NONE guibg=bg guifg=#af875f gui=NONE
    hi Delimiter ctermbg=NONE ctermfg=137 cterm=NONE guibg=bg guifg=#af875f gui=NONE
    hi Boolean ctermbg=NONE ctermfg=67 cterm=NONE guibg=bg guifg=#5f87af gui=NONE
    hi VimIsCommand ctermbg=235 ctermfg=254 cterm=NONE guibg=#262626 guifg=#e4e4e4 gui=NONE
    hi VimFunction ctermbg=NONE ctermfg=254 cterm=bold guibg=bg guifg=#e4e4e4 gui=bold
    ...
    hi javaScriptObjectKey ctermbg=NONE ctermfg=110 cterm=NONE guibg=bg guifg=#87afd7 gui=NONE
    hi javaScriptFunctionKey ctermbg=235 ctermfg=180 cterm=NONE guibg=#262626 guifg=#d7af87 gui=NONE
    hi htmlItalic ctermbg=NONE ctermfg=110 cterm=NONE guibg=bg guifg=#87afd7 gui=NONE
    hi markdownLinkTextDelimiter ctermbg=NONE ctermfg=110 cterm=NONE guibg=bg guifg=#87afd7 gui=NONE
    hi markdownLinkDelimiter ctermbg=NONE ctermfg=25 cterm=NONE guibg=bg guifg=#005faf gui=NONE
    hi markdownUrl ctermbg=NONE ctermfg=25 cterm=NONE guibg=bg guifg=#005faf gui=NONE
    hi markdownCodeBlock ctermbg=NONE ctermfg=137 cterm=NONE guibg=bg guifg=#af875f gui=NONE
    hi markdownCode ctermbg=NONE ctermfg=137 cterm=NONE guibg=bg guifg=#af875f gui=NONE
    hi helpExample ctermbg=NONE ctermfg=137 cterm=NONE guibg=bg guifg=#af875f gui=NONE
    hi manSectionHeading ctermbg=NONE ctermfg=137 cterm=NONE guibg=bg guifg=#af875f gui=NONE
    hi manOptionDesc ctermbg=NONE ctermfg=223 cterm=NONE guibg=bg guifg=#ffd7af gui=NONE
    hi manLongOptionDesc ctermbg=NONE ctermfg=110 cterm=NONE guibg=bg guifg=#87afd7 gui=NONE
    hi CtrlPNoEntries ctermbg=NONE ctermfg=20 cterm=NONE guibg=bg guifg=#0000d7 gui=NONE
    hi CtrlPMatch ctermbg=NONE ctermfg=223 cterm=NONE guibg=bg guifg=#ffd7af gui=NONE
    hi CtrlPLinePre ctermbg=NONE ctermfg=25 cterm=NONE guibg=bg guifg=#005faf gui=NONE
    hi CtrlPPrtBase ctermbg=NONE ctermfg=25 cterm=NONE guibg=bg guifg=#005faf gui=NONE
    hi CtrlPPrtText ctermbg=NONE ctermfg=254 cterm=NONE guibg=bg guifg=#e4e4e4 gui=NONE
    hi CtrlPPtrCursor ctermbg=NONE ctermfg=68 cterm=NONE guibg=bg guifg=#5f87d7 gui=NONE
    hi CtrlPBufferInd ctermbg=NONE ctermfg=223 cterm=NONE guibg=bg guifg=#ffd7af gui=NONE
    hi CtrlPBufferVis ctermbg=NONE ctermfg=110 cterm=NONE guibg=bg guifg=#87afd7 gui=NONE
    hi CtrlPBufferNr ctermbg=NONE ctermfg=67 cterm=NONE guibg=bg guifg=#5f87af gui=NONE
elseif &t_Co == 8 || $TERM !~# '^linux' || &t_Co == 16
    ...
    hi Special ctermbg=NONE ctermfg=orange cterm=NONE
